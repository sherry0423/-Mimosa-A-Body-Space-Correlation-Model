...
class StroopTest:
    def __init__(self, root):
        ...
        self.english_colors = ["Red", "Green", "Blue", "Yellow", "Purple"]
        self.color_codes = {
            "红色": "#FF0000",
            "绿色": "#00FF00",
            "蓝色": "#0000FF",
    ...
    def create_widgets(self):
        ...
        例如：
        - 如果看到用红色书写的"Blue"，你应该按红色对应的按钮。
        - 如果看到用绿色书写的"Yellow"，你应该按绿色对应的按钮。
        ...
        self.instruction_label = tk.Label(
            self.test_frame,
            text="Please choose the color of the word above:",
            font=self.default_font,
            bg="#f0f0f0"
        )
